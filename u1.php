...
<?php								 
    ...
    $query = "UPDATE land SET owner_name='$owner_name',phone_number='$phone_number',address='$address' WHERE land_name='$land_name'";
  ...
  while ($arr=mysqli_fetch_row($var))
   ...
   echo"</table>";
?>
<p align="down"><center><a href="sbm1.html" class="button"><span>HOME</span></a></center></html>
</body>